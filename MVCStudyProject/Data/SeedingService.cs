...
using MVCStudyProject.Models.Enums;
using System;
...
namespace MVCStudyProject.Data
{
    ...
    {
        private MVCStudyProjectContext _context;

        public SeedingService(MVCStudyProjectContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 21), 1000.0, department1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1979, 12, 31), 3500.0, department2);
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.0, department1);
